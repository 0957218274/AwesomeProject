            ...
            <FlatList
                ...
                renderItem={
                    ({ item, index }) => {
                        ...
                        return (
                            <View style={{
                                marginRight: 10, backgroundColor: 'lightsteelblue', borderTopRightRadius: 10, borderTopLeftRadius: 10,
                                borderBottomLeftRadius: 10, borderBottomRightRadius: 10
                            }}>
                                <Image source={{ uri: item.uri }} style={{
                                    width: 350, height: 150, borderTopRightRadius: 10,
                                    borderTopLeftRadius: 10
                                }} />
                                {/* Text */}
                                <View style={{
                                    flexDirection: 'row', borderWidth: 10, borderBottomLeftRadius: 10, borderBottomRightRadius: 10,
